			...
			<div id="left-area" <?= $style ?>>
	            ...
	            <? if(isset($verticalTabs) and $verticalTabs == true): ?>
		            ...
		            <div class="top-menu">
			            ...
			            <? $ativo = ($class == 'jogo' AND $method == 'escolherSetorVida' AND isset($query['p']) == false) ? ' ativo' : '' ?>
			            <? if($ativo == ''): ?>
		            ...
		            <div class="content">
		            	<? /*
		            		* banner de cima desativado
				            	<div style="margin: 10px 0;">
									<iframe id="horizontal-banner" src="<?=base_url()?>assets/estatico/banner-horizontal_img.html" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" vspace="0" hspace="0" width="730" height="20"></iframe>
								</div>
							*/ 
						?>
			            <?=$view?>
